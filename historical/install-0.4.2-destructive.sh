#!/bin/bash
# DEPRECATED — historical / unsafe public installer for frozen 0.4.2.
# Do not use for new installs. Retained only as a record of the old
# destructive path (port kill, venv rm -rf, pip uninstall, auto-Sync).
# Current public bootstrap: /install.sh on tag citizen-runtime-0.4.2.1
#
set -e
